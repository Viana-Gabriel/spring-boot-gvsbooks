...
public class LivroController {
  ...
  @PostMapping
  @Transactional
  public ResponseEntity cadastrarLivros(@RequestBody LivroDTO dados, UriComponentsBuilder uriBuilder) {
  ...
  @PutMapping
  @Transactional
  public ResponseEntity atualizaLivro(@RequestBody AtualizaLivroDTO dados){
